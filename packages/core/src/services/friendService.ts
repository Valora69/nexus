...
export const sendFriendRequest = async (
  ...
  const response = await http(`${BASE}${FRIEND_URI}/request`, {
    method: 'POST',
...
> => {
  const response = await http(`${BASE}${FRIEND_URI}/requests`, {
    method: 'GET',
    credentials: 'include',
    headers: {
      'Content-Type': 'application/json',
...
export const getSentRequests = async (): Promise<
  FriendRequestWithRelations[]
> => {
  const response = await http(`${BASE}${FRIEND_URI}/requests/sent`, {
    method: 'GET',
    credentials: 'include',
    headers: {
      'Content-Type': 'application/json',
...
export const getAllFriends = async (): Promise<Friend[]> => {
  const response = await http(`${BASE}${FRIEND_URI}`, {
    method: 'GET',
    credentials: 'include',
    headers: {
      'Content-Type': 'application/json',
...
export const removeFriend = async (
  ...
  const response = await http(`${BASE}${FRIEND_URI}/${friendId}`, {
    method: 'DELETE',
    credentials: 'include',
    headers: {
      'Content-Type': 'application/json',
