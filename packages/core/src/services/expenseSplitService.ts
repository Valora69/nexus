...
export const getAllExpenseSplits = async (): Promise<
  ExpenseSplitWithRelations[]
> => {
  const response = await http(`${BASE}${EXPENSE_SPLIT_URI}`, {
    method: 'GET',
    credentials: 'include',
...
export const getMyPayableSplits = async (): Promise<
  ExpenseSplitWithRelations[]
> => {
  const response = await http(`${BASE}${EXPENSE_SPLIT_URI}/my-payables`, {
    method: 'GET',
    credentials: 'include',
    headers: { 'Content-Type': 'application/json' },
  });
...
export const getMyReceivableSplits = async (): Promise<
  ExpenseSplitWithRelations[]
> => {
  const response = await http(`${BASE}${EXPENSE_SPLIT_URI}/my-receivables`, {
    method: 'GET',
    credentials: 'include',
    headers: { 'Content-Type': 'application/json' },
  });
...
export const getSplitsByUserId = async (
  ...
  const response = await http(`${BASE}${EXPENSE_SPLIT_URI}/user/${userId}`, {
    method: 'GET',
    credentials: 'include',
    headers: { 'Content-Type': 'application/json' },
  });
...
export const getExpenseSplitById = async (
  ...
  const response = await http(`${BASE}${EXPENSE_SPLIT_URI}/${id}`, {
    method: 'GET',
    credentials: 'include',
    headers: { 'Content-Type': 'application/json' },
  });
...
export const markSplitAsPaid = async (
  ...
  const response = await http(`${BASE}${EXPENSE_SPLIT_URI}/${id}/mark-paid`, {
    method: 'POST',
    credentials: 'include',
    headers: { 'Content-Type': 'application/json' },
