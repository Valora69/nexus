...
|---|---|
| Keycap toy ("hey! click me") | **₱ coin key** ("hey! tap to add ↙"). Each tap drops a random expense (Grab ₱240, Pizza night ₱1,200, Milk tea ₱390, Groceries ₱3,450) into the laptop's group ledger with a spring. A toast reads "New Expense Added", and a coin clink plays. |
